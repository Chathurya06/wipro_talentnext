...
public class Miniproject1 {
	...
	//public static void main(String[] args) {
		...
		static class Employee {
		    ...
		    public static void main(String[] args) {
		        if (args.length != 1) {
		            System.out.println("Please enter a single Employee ID as command line argument.");
		            return;
		        }
		        ...
		        char[] desigCodes = {'e', 'c', 'k'};
		        String[] designations = {"Engineer", "Consultant", "Clerk"};
		        int[] das = {20000, 32000, 12000};
		        ...
		        for (Employee emp : employees) {
		            if (emp.empNo == empId) {
		                ...
		                // Get designation and DA
		                String designation = "";
		                int da = 0;
		                for (int i = 0; i < desigCodes.length; i++) {
		                    if (emp.designationCode == desigCodes[i]) {
